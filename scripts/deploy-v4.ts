...
// Configuration
const NEW_MARKET_CONTRACT_NAME = 'stackodds-market-v4';
...
async function main() {
    try {
        ...
        console.log('Waiting 45 seconds for deployment to register... (you might need to run initialize separately if it fails)');
        await new Promise(r => setTimeout(r, 45000));

        // We try to initialize with the next nonce immediately
        // Note: On mainnet, the deployment should ideally be confirmed first.
        // But we can try to chain them if the API allows.
